 ...
 */
public class ZMultipleImageSelectAdapter extends ZMultipleImageGenericAdapter<Photo> {
    public ZMultipleImageSelectAdapter(Context context, ArrayList<Photo> images) {
